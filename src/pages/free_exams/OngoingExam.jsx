...
const OngoingExam = () => {
  ...
  useEffect(() => {
    if (TOKEN) {
      ...
      axios
        .get("/api/freestudent/examcheckmiddleware?eId=" + params.get("examId"))
        .then(({ data }) => {
          if (data === "assign") {
            ...
            axios
              .get(
                "/api/freestudent/getrunningdata?eId=" + params.get("examId")
              )
              .then(({ data }) => {
                ...
                if (!localStorage.getItem(params.get("examId"))) {
                  ...
                  let _local = JSON.parse(
                    localStorage.getItem(params.get("examId"))
                  );
            ...
            axios
              .get(
                `/api/freestudent/getexambyid?examId=${params.get("examId")}`
              )
              .then(({ data }) => {
                console.log(data);
                setExam(data);
